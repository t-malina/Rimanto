...
import de.kalkihe.rimanto.model.wordbook.StubWordbook;
...
public class RimantoIOCContainer {
  ...
  /**
   * Returns an instance of the passed class, Uses created singleton objects if
   * applicable
   * 
  ...
  public Object getInstanceFor(Class wantedClass) throws Exception {
    if (wantedClass == IRimantoModel.class) {
      ...
      if (this.eventProcessor == null) {
        this.eventProcessor = new EventProcessor((IRimantoView) this.getInstanceFor(IRimantoView.class),
            (IRimantoModel) this.getInstanceFor(IRimantoModel.class),
            (IWordbook) this.getInstanceFor(IWordbook.class));
      }
      return this.eventProcessor;
    } else if (wantedClass == IPanelGetter.class) {
      if (this.panelGetter == null) {
        this.panelGetter = new PanelGetter((IWordbook) this.getInstanceFor(IWordbook.class),
            (IEventProcessor) this.getInstanceFor(IEventProcessor.class),
